...
| 7            | Hardening, perf/a11y, CI/CD, backups                                                                                                                                 | **Planned** — master plan `docs/stage-7-hardening-launch-plan.md` (2026-07-12; P0 decisions → P1 security/CSP → P2 concurrency → P3 observability → P4 perf/a11y → P5 CI/CD → P6 backup/DR → P7 content/domain cut-over → P8). Not started |
